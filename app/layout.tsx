...
import './globals.css'
// import '@/lib/polyfills' // Temporarily disabled to debug 500 error
...
export const metadata: Metadata = {
  title: 'Go the Nine - 75 Hard Tracker',
  description: 'Track your 75 Hard Challenge progress with Go the Nine',
